...
function publish(exchange, routingKey, content) {
  ...
  return pWaterfall([
    ...
    channel => {
      ...
      // According to the ampq protocol, unroutable messages are returned before they are acknowledged
      return Promise.race([
      ...
      .finally(() => onMessageReturned.detatch());
    },
...
function _createConfirmChannel(ctx) {
  ...
  return ctx.connection.createConfirmChannel()
    .then(channel => {
      ...
      return { channel, saturated: false, ...ctx }
    });
}
